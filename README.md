...
Latest local verification: `222 tests OK`.
...
- P0 file-backed session ledger is wired into the main loop; deeper resume and compaction recovery are still roadmap items.
