...
- the swarm kernel has CLI, observability-ready receipts, a local inspection API, and a public mixed OpenAgent+A2A example, but still needs optional Langfuse receipt annotations.
...
6. Add optional Langfuse receipt annotations for the decoupled [Swarm Function Kernel](swarm.md).
