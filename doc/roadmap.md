...
- Decoupled swarm/function kernel with function runners, subprocess runners, HTTP runners, YAML config, multi-runner dispatch, an OpenAgent runner adapter, local trace lineage, optional Langfuse export, and opt-in worker workspace isolation.
...
- the swarm kernel does not yet have A2A, merge-back review, or persistent team adapters.
...
6. Add merge-back review, A2A runners, and persistent team state on top of the decoupled [Swarm Function Kernel](swarm.md).
