...
- Decoupled swarm/function kernel with function runners, subprocess runners, HTTP runners, YAML config, multi-runner dispatch, an OpenAgent runner adapter, local trace lineage, and optional Langfuse export.
...
- the swarm kernel does not yet have A2A or persistent team adapters.
...
6. Add A2A runners and worker isolation on top of the decoupled [Swarm Function Kernel](swarm.md).
