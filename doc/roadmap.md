...
- the swarm kernel has CLI, observability-ready receipts, a local inspection API, optional Langfuse receipt annotations, and a public mixed OpenAgent+A2A example, but still needs richer mixed-runner examples and a small browser-facing inspection view.
...
6. Add richer mixed-runner examples for the decoupled [Swarm Function Kernel](swarm.md).
