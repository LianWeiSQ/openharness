...
- the swarm kernel has CLI, observability-ready receipts, a local inspection API, optional Langfuse receipt annotations, and public mixed OpenAgent/non-OpenAgent examples, but still needs a small browser-facing inspection view.
...
6. Add a small browser-facing inspection view for the decoupled [Swarm Function Kernel](swarm.md).
