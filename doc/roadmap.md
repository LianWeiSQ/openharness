...
- the swarm kernel does not yet have A2A task subscription reconnect support or CLI examples for running swarm configs.
...
6. Add A2A task subscription reconnect support and CLI examples for the decoupled [Swarm Function Kernel](swarm.md).
