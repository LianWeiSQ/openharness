...
- Decoupled swarm/function kernel with function runners, subprocess runners, HTTP runners, YAML config, multi-runner dispatch, an OpenAgent runner adapter, and local trace lineage.
...
- the swarm kernel does not yet have Langfuse export, A2A, or persistent team adapters.
...
6. Add Langfuse export and A2A runners on top of the decoupled [Swarm Function Kernel](swarm.md).
