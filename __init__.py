...
or setting `PYTHONPATH=openagent/src`.

When installed (via `pip install -e openagent`), the real package lives under
`openagent/src/openagent/` and this file is not included.
"""
...
def _extend_package_path() -> None:
    ...
    # 中文说明：
    # - 本仓库的 Python 包采用 src/ 布局：实际源码在 openagent/src/openagent/
