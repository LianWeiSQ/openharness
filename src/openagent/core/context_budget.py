...
def check_context_budget(
    *,
    ...
    config = _parse_context_budget_options(options, model=model)
    ...
    if strategy not in SUPPORTED_STRATEGIES:
        raise ContextBudgetConfigError(
            ...
            "Supported strategies: error. "
            "TODO: compact/trim are reserved for a future implementation."
        )
...
def _parse_context_budget_options(
    ...
    *,
    ...
    reserve_output_tokens = raw_context_budget.get("reserve_output_tokens", model.max_output)
...
# TODO: support strategy="compact" by summarizing/compacting old context before retrying.
